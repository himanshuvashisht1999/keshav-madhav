                                                                ...
                                                                <div class="card-body p-4 bg-white border-top">
                                                                    ${carton.boxes.length > 0 ? `
                                                                         <div class="d-flex flex-wrap" style="gap: 8px;">
                                                                             ${carton.boxes.map(b => `
                                                                                 <div class="badge border text-dark py-2 px-3 bg-light d-flex align-items-center" style="border-radius: 8px; font-weight: 500;">
                                                                                     <i class="fas fa-barcode mr-1 opacity-50"></i> #${b.box_no}
                                                                                     ${(b.domestic_inventory) ? `
                                                                                         <a href="/admin/packing/download-domestic-barcode-txt/${b.domestic_inventory.id}" 
                                                                                            class="btn btn-link py-0 px-1 ml-1 text-primary" 
                                                                                            title="Download TXT Barcode"
                                                                                         >
