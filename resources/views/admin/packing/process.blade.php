...
@section('content')
                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        <div class="alert alert-info py-2 small">
                            DEBUG: Order Type: "{{ $order->order_type ?? 'NULL' }}" | Order ID: {{ $order->id ?? 'NULL' }} |
                            Masters Count: {{ count($domestic_masters ?? []) }}
                        </div>
                    </div>
                        ...
                        <div class="card h-100">
                            <div
                                ...
                                <div>
                                    ...
                                    <button class="btn btn-outline-danger btn-sm rounded-pill px-3 mr-2"
                                        onclick="resetSlip()" id="btnResetSlip" @if(!$order || ($packing && $packing->status == 1)) disabled @endif>
                                    ...
                                    <button class="btn btn-success btn-sm ms-2" onclick="finalizePacking()" id="btnFinalize"
                                        @if(!$order || ($packing && $packing->status == 1)) disabled @endif>
    ...
    <!-- CORPORATE MULTI-CARTON PLANNER MODAL -->
    <div class="modal fade" id="multiCartonPlannerModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-xl" style="max-width: 95%;">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-primary text-white p-3">
                    <h5 class="modal-title font-weight-bold mb-0"><i class="fas fa-layer-group mr-2"></i> Multi-Carton
                        Planner</h5>
                ...
                <div class="modal-body p-0">
                    <div class="row no-gutters">
                        <div class="col-md-2 bg-light border-right p-3">
                            <h6 class="font-weight-bold text-muted mb-3 small text-uppercase">Available at Unit</h6>
                            <div id="plannerInventoryList" style="max-height: 700px; overflow-y: auto;">
                                <p class="text-muted small">Loading availability...</p>
                            </div>
                        </div>
                                ...
                                <div class="card-body p-3">
                                    ...
                                    <div class="row g-2">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <select id="rangeColor" class="form-control form-control-sm"
                                                onchange="updateRangeTypeOptions()"></select>
                                        </div>
                                        <div class="col-md-2">
                                            <label class="small font-weight-bold mb-0">Type</label>
                                            <select id="rangeType" class="form-control form-control-sm"
                                                onchange="updateRangeTypeOptions()">
                                                <option value="set">Box (Set)</option>
                                                <option value="loose">Loose</option>
                                            </select>
                                        </div>
                                        <div id="rangeSizeContainer" class="col-md-1 d-none">
                                            <label class="small font-weight-bold mb-0">Size</label>
                                            <select id="rangeSize" class="form-control form-control-sm"></select>
                                        </div>
                                        <div class="col-md-1">
                                            <label class="small font-weight-bold mb-0">Qty</label>
                                            <input type="number" id="rangeQty" class="form-control form-control-sm"
                                                value="1" oninput="validateUnitPackagingStock(this)">
                                        </div>
                                        <div class="col-md-1">
                                            <label class="small font-weight-bold mb-0">MRP</label>
                                            <input type="number" id="rangeMrp" class="form-control form-control-sm"
                                                step="0.01">
                                        </div>
                                        <div class="col-md-1">
                                            <label class="small font-weight-bold mb-0">Price</label>
                                            <input type="number" id="rangePrice" class="form-control form-control-sm"
                                                step="0.01">
                                        </div>
                                        <div class="col-md-2 d-flex align-items-end">
                                            <button type="button" class="btn btn-primary btn-sm btn-block"
                                                onclick="addRangeToPlanner()">
                                    ...
                                    <div class="row g-2 mt-2">
                                        <div class="col-md-3">
                                            ...
                                            <select id="rangeStore" class="form-control form-control-sm"
                                                onchange="updateRangeRacks()">
                                                <option value="">Select Store Room</option>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" id="rangeBarcode" class="form-control form-control-sm"
                ...
                <div class="modal-footer bg-light p-3">
                    ...
                    <button type="button" class="btn btn-success px-5 shadow-sm font-weight-bold"
                        onclick="submitMultiCartonPlan()">
                        ...
                        <div class="col-md-10 p-3">
                            ...
                            <div class="card bg-info-light border-0 mb-4" style="background-color: #f0f7ff;">
                                <div class="card-body p-3">
                                    <div class="row g-2">
                                        ...
                                        <div class="col-md-2">
                                            <label class="small font-weight-bold mb-0">Color</label>
                                            <select id="domColor" class="form-control form-control-sm"
                                                onchange="updateDomAttributes()"></select>
                                        </div>
                                        <div class="col-md-12 mt-2" id="domSizePreview" style="display:none;">
                                            <div class="alert alert-light border py-1 px-2 mb-0 d-flex align-items-center">
                                                <i class="fas fa-info-circle mr-2 text-info small"></i>
                                                <span class="small font-weight-bold text-muted mr-2">SIZE
                                                    COMPOSITION:</span>
                                                <div id="domSizeBadges"></div>
                                            </div>
                                        </div>
                                        <div class="col-md-1 mt-2">
                                            <label class="small font-weight-bold mb-0">Qty</label>
                                            <input type="number" id="domQty" class="form-control form-control-sm" value="1">
                                        </div>
                                        <div class="col-md-2">
                                        ...
                                        <div class="col-md-2">
                                            <label class="small font-weight-bold mb-0">Rack</label>
                                            <select id="domRack" class="form-control form-control-sm"></select>
                                        </div>
                                        <div class="col-md-1 d-flex align-items-end">
                                            <button type="button" class="btn btn-info btn-sm btn-block"
                                                onclick="addDomesticToPlanner()">Add</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <button type="button" class="btn btn-link btn-sm text-danger"
                                    onclick="$('#domesticTableBody').empty()">Clear All</button>
                            </div>
    ...
    @push('scripts')
        <script>
            ...
            function renderStructure() {
                ...
                if (packedStructure.cartons.length > 0) {
                    ...
                    packedStructure.cartons.forEach((carton, index) => {
                        ...
                        if (carton.boxes && carton.boxes.length > 0) {
                            carton.boxes.forEach(box => {
                                if (box.domestic_inventory && box.domestic_inventory.product) {
                                    ...
                                    if(box.domestic_inventory.color) colors.push(box.domestic_inventory.color.name);
                                    if(box.domestic_inventory.size_set) sizeSets.push(box.domestic_inventory.size_set.name);
                                } else if (box.items && box.items.length > 0 && box.items[0].detail && box.items[0].detail.order_product_set) {
                                    let ops = box.items[0].detail.order_product_set;
                        ...
                        let designNo = [...new Set(designs)].join(', ') || 'N/A';
                        let colorName = [...new Set(colors)].join(', ') || 'N/A';
                        let sizeSetName = [...new Set(sizeSets)].join(', ') || 'N/A';
            ...
            function resetSlip() {
                if (!SLIP_ID) return;
                if (!confirm("Are you sure you want to WIPE ALL CARTONS from this slip and completely reset it? This will completely undo all packing done in this slip and return stock to the unit. This cannot be undone.")) return;
                
                window.location.href = "{{ url('fix-cartons') }}/" + SLIP_ID;
            }
                        ...
                        <div class="col-md-5 border-left">
                            ...
                            <div class="form-group mt-3 bg-light p-3 rounded border">
                                ...
                                <div class="h3 font-weight-bold text-dark mb-0">
                                    ₹ <span id="debitTotalDisplay">0.00</span>
                                </div>
