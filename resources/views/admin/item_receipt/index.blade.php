...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Manage Item Receipt</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item active">Manage Item Receipt</li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <table id="customers" class="table table-bordered table-hover">
                  <thead>
                    <tr role="row" class="filter">
                        ...
                        <td>
                            <input type="text" class="form-control" name="box" id="box" autocomplete="off">
                        </td>
                        <td>
...
<script>
    $(function () {
        ...
        var oTable = $('#customers').DataTable({
            ...
            "pageLength":25,
            ajax: {
                url: '{!! route('admin.item_receipt.indexList') !!}',
                data: function (d) {
                    d.id = $('#id').val();
                    d.sku = $('#sku').val();
            ...
            buttons: [
                {
                    text: 'Add Item Receipt',
                    className: 'btn-datatable',
                    action: function (e, dt, node, config) {
                        window.location.href = "{{ route('admin.item_receipt.create') }}";
                    }
                }
            ]
        });
    ...
    function deleteData(id){
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "{{ route('admin.item_receipt.delete', ['id' => '']) }}" + id;
            }
        });
    }
</script>
