            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Create Item Receipt</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Create Item Receipt</h3>
                </div>
                <form action="{{route('admin.item_receipt.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
...
<script>
    function generateSKU() {
        ...
        let box = document.getElementById("box").value.trim().replace(/\s+/g, '');
        ...
        // 4️⃣ Boxes (no spaces, alphanumeric only)
        let part4 = box.replace(/[^a-zA-Z0-9]/g, '').toUpperCase();
    ...
    $(document).ready(function() {
        ...
        $('#truck_number, #box, #received_by').on("input", generateSKU);
