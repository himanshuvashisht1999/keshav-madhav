                    ...
                    <div class="card shadow-sm border-left-primary h-100">
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                ...
                                <span class="font-weight-bold text-dark">{{ $order_dispatch_data['dispatch_date'] }}</span>
                            </div>
                            <div class="d-flex justify-content-between">
                                <span class="text-muted">Dispatch No:</span>
                                <span class="font-weight-bold text-dark">{{ $order_dispatch_data['order_dispatch_no'] }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card shadow-sm border-left-success h-100">
                        <div class="card-body">
                            ...
                            <div class="mb-2">
                                ...
                                <span class="font-weight-bold h5 text-dark">{{ $order_dispatch_data['customer'] }}</span>
                            </div>
                             <div>
                ...
                <div class="col-md-4">
                    <div class="card shadow-sm border-left-info h-100">
                        <div class="card-body text-center">
                            <h6 class="text-info font-weight-bold text-uppercase mb-3">Dispatch Summary</h6>
                            <div class="row">
                                <div class="col-6 border-right">
                                    <h3 class="font-weight-bold text-dark mb-0">{{ $order_dispatch_data['total_cartons'] }}</h3>
                                    <small class="text-muted text-uppercase font-weight-bold" style="letter-spacing:1px;">Cartons</small>
                                </div>
                                <div class="col-6">
                                    <h3 class="font-weight-bold text-dark mb-0">{{ $order_dispatch_data['total_items_dispatch'] }}</h3>
                                    <small class="text-muted text-uppercase font-weight-bold" style="letter-spacing:1px;">Total Items</small>
                                </div>
                            </div>
                        </div>
                    </div>
...
<style>
    ...
    @media print {
        .btn, .main-footer, .navbar { display: none !important; }
