    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row align-items-center">
                <div class="col-sm-6">
                    <h1 class="m-0 font-weight-bold text-dark"><i class="fas fa-scroll mr-2 text-primary"></i>Fabric Order: {{ $shop->name }}</h1>
                    <p class="text-muted small mb-0"><i class="fas fa-user-tie mr-1"></i> {{ ($agent && $agent->id === 'direct') ? 'Direct Sale (No Agent)' : 'Agent: ' . ($agent->name ?? 'N/A') }}</p>
                </div>
                <div class="col-sm-6 text-right">
                    <a href="{{ route('admin.agent-orders.create') }}" class="btn btn-outline-secondary btn-sm rounded-pill px-3">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush mb-4">
                                ...
                                <li class="list-group-item d-flex justify-content-between px-0 py-2 border-0 align-items-center">
                                    ...
                                    <input type="number" id="discountPercentage" class="form-control form-control-sm text-right w-25 border-info" value="0" min="0" max="100">
                                </li>
                                <li class="list-group-item d-flex justify-content-between px-0 py-2 border-0 align-items-center">
                                    <span class="text-muted">GST (%):</span>
                                    <input type="number" id="gstPercentage" class="form-control form-control-sm text-right w-25 border-info" value="{{ $gst_percentage }}" min="0" max="100" step="0.1">
                                </li>
                                <li class="list-group-item d-flex justify-content-between px-0 py-2 border-0">
                                ...
                                <li class="list-group-item d-flex justify-content-between px-0 py-2 border-0 align-items-center">
                                    ...
                                    <input type="number" id="other_charges" class="form-control form-control-sm text-right w-50 border-info" value="0" min="0" step="1">
                                </li>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="date" id="expectedDispatchDate" class="form-control" value="{{ date('Y-m-d', strtotime('+3 days')) }}" min="{{ date('Y-m-d') }}">
                            </div>
                            ...
                            <div class="row">
                                <div class="col-6 pr-1">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" id="booking_station" class="form-control" placeholder="Booking">
                                    </div>
                                </div>
                            ...
                            <textarea id="orderRemark" class="form-control mb-4" rows="2" placeholder="Instructions..."></textarea>

                            <button type="button" class="btn btn-success btn-lg btn-block shadow-lg rounded-pill place-fabric-order-btn" id="placeOrderBtn" disabled title="Fulfill targets to enable">
