...
<body>
    <div class="main-container">
            ...
            <table width="100%" style="border-collapse: collapse;">
                <tr>
                    ...
                    <td width="60%" class="text-center">
                        <div class="title">ORDER FORM (FABRIC)</div>
        ...
        <table class="items-table">
            ...
            <tbody>
                ...
                @foreach($items as $index => $item)
                    ...
                    @php $tMeters += $item->meter; $tAmt += ($item->meter * $item->selling_price); @endphp
                @endforeach
        ...
        <div style="padding: 15px; border-top: 1px solid #000; font-size: 10px;">
            ...
            * This is an automated order acknowledgement sheet for Fabric order.
        </div>
