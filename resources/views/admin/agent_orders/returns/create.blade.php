                            ...
                            <div class="card-body">
                                    ...
                                    <div class="row no-gutters">
                                        <div class="col-5">
                                            <div class="input-group input-group-sm shadow-sm">
                                                <input type="number" id="discountPercentage" name="discount_percentage" class="form-control" value="0" step="any">
                                        ...
                                        <div class="col-7 pl-1">
                                            <div class="input-group input-group-sm shadow-sm">
                                                <div class="input-group-prepend"><span class="input-group-text">₹</span></div>
                                                <input type="number" id="discountAmountInput" class="form-control" value="0" step="any">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group mb-2 border-top pt-2">
                                    ...
                                    <div class="row no-gutters">
                                        <div class="col-5">
                                            <div class="input-group input-group-sm shadow-sm">
                                                <input type="number" id="gstPercentage" name="gst_percentage" class="form-control" value="{{ $dispatch->gst_percentage ?? 5 }}" step="any">
                                                <div class="input-group-append"><span class="input-group-text">%</span></div>
                                            </div>
                                        </div>
                                        <div class="col-7 pl-1">
                                            <div class="input-group input-group-sm shadow-sm">
                                                <div class="input-group-prepend"><span class="input-group-text">₹</span></div>
                                                <input type="number" id="gstAmountInput" class="form-control" value="0" step="any">
                                            </div>
                                        </div>
                                    </div>
