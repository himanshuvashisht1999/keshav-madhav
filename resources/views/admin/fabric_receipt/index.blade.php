                        ...
                        <table id="customers" class="table table-bordered table-hover">
                            <thead>
                                <tr role="row" class="filter">
                                    ...
                                    <td>
                                        <select class="form-control select2" name="master_fabric_warehouse_id"
                                            id="master_fabric_warehouse_id" style="width: 100%;">
                                            <option value="">ALL</option>
                                            @foreach($cutting_units as $fabric_warehouse)
                                                <option value="{{$fabric_warehouse->id}}">
                                                    {{$fabric_warehouse->cutting_master_name}}</option>
                                            @endforeach
                                        </select>
                                    </td>
