            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    @can('manage-inventory')
                        <li
                            class="{{ (str_contains($page_url, 'admin/inventory') || str_contains($page_url, 'admin/agent-orders')) ? 'nav-item menu-open' : 'nav-item' }}">
                            <a href="#"
                                class="{{ (str_contains($page_url, 'admin/inventory') || str_contains($page_url, 'admin/agent-orders')) ? 'nav-link active' : 'nav-link' }} border_class">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ route('admin.inventory.outflow.index') }}"
                                        class="{{ str_contains($page_url, 'admin/inventory/outflow') ? 'nav-link active' : 'nav-link' }}"
                                        style="position:static;">
