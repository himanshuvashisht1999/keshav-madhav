                            ...
                            <tbody>
                                @forelse($orders as $order)
                                    <tr>
                                        ...
                                        <td class="text-primary font-weight-bold">₹{{ number_format($order->grand_total, 2) }}</td>
                                        ...
                                        <td class="text-right pr-4">
                                            <a href="{{ route('admin.agent-orders.download-invoice', $order->id) }}" class="btn btn-sm btn-info mr-1" title="Invoice">
                                                <i class="fas fa-file-invoice"></i>
                                            </a>
                                            <a href="{{ route('admin.agent-orders.show', $order->id) }}" class="btn btn-sm btn-primary">
                                ...
                                @empty
                                    <tr>
                                        <td colspan="9" class="text-center py-5 text-muted">No direct sales orders found.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
