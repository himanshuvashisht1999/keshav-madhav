...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Item Receipt Report</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item active">Item Receipt Report</li>
                    </ol>
                </div>
            </div>
        </div>
...
<script>
    $(function () {
        ...
        var oTable = $('#customers').DataTable({
            ...
            "pageLength":25,
            ajax: {
                url: '{!! route('admin.reports.itemReceiptList') !!}',
                data: function (d) {
                    d.id = $('#id').val();
                    d.sku = $('#sku').val();
        ...
        $(document).ready(function () {
            $('#generateExcel').on('click', function (e) {
                ...
                var form = $('<form>', {
                    action: '{{ route("admin.reports.itemReceiptExcel") }}',
                    method: 'POST',
                    target: '_blank'
