...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="text-center">Sales Order</h1>
                </div>
                {{-- <div class="col-sm-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card p-3 border">
                                ...
                                <div class="product-row">
                                    ...
                                    @endif
                                    <div class="col-md-12">
                                        <label>Name of the Set Size</label>
                                    ...
                                    <select class="form-control select2 mb-2 size-input" name="set_size" id="set_size">
                                        ...
                                        @foreach($product_size as $size)
                                            <option value="{{ $size->id }}" data-set-group="{{ $size->size_group ?? '' }}">{{ $size->name }}</option>
                                        @endforeach
                                    </select>
