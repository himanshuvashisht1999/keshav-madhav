                    ...
                    <div class="card shadow-sm border-0">
                        <div class="card-body">
                            <form action="{{ route('admin.sales_order.store_domestic') }}" method="POST">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group mb-3">
                                            <div class="d-flex justify-content-between align-items-center mb-1">
                                                ...
                                                <a href="javascript:void(0)" id="openCustomSizeBtn" class="text-primary font-weight-bold" style="display:none; font-size:13px; text-decoration:underline;">
                                                    Update Ratio
                                                </a>
                                            </div>
                                            <select name="set_size_id" id="set_size_id" class="form-control select2" required>
                                            ...
                                            <div id="custom_ratio_info" class="mt-1 small text-success font-weight-bold"></div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <select id="warehouse_id" class="form-control select2" onchange="warehouseChange(this.value)">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <select name="master_cutting_id" id="master_cutting_id" class="form-control select2">
                                    ...
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group mb-3">
                                                    <label>Fitting</label>
                                                    <select name="master_fitting_id" id="master_fitting_id" class="form-control select2">
                                ...
                                <div class="form-group mb-4">
                                    <label>Remark</label>
                                    <textarea name="remark" class="form-control" rows="2" placeholder="Any special instructions..."></textarea>
                                </div>
...
<div class="modal" id="sizeModal">
    <div class="modal-content">
        <div class="modal-header">
            ...
            <button type="button" class="close" onclick="closeModal()" style="border:none; background:none; font-size:24px;">&times;</button>
        </div>
