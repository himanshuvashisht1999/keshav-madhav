    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <form action="{{ route('admin.product_order.updateOrderMain', $data->id) }}" method="POST"
                    ...
                    <div class="card p-3 mb-3 shadow-sm border-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="hidden" name="expected_delivery_date" id="ex_d_date_hidden"
                                    value="{{ $data->expected_delivery_date }}">
                            </div>
                            ...
                            <div class="col-md-4 mt-3">
                                <label>PO Date</label>
                                <input type="date" name="po_date" class="form-control" value="{{ $data->po_date }}">
                            </div>
                            ...
                            <div class="col-md-4 mt-3">
                                @if($data->corporate_order_file)
                                    <div id="existingFileBox" class="mt-2 p-2 border rounded bg-light">
                                        ...
                                        <a href="{{ asset('assets/products/' . $data->corporate_order_file) }}" target="_blank"
                                ...
                                @foreach($data->OrderProductSets as $set)
                                    <tr class="product-row-item">
                                        ...
                                        <td>
                                            ...
                                            <input type="hidden" name="total_quantity[]" class="row-total-qty-input"
