                ...
                <div class="premium-card p-3 h-100">
                    ...
                    <table class="table table-sm table-borderless mb-0">
                        ...
                        <tr>
                            ...
                            <td class="font-weight-bold">{{ $batch->created_at->format('d M Y, h:i A') }}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                @if($sample->product->display_image)
                                    <img src="{{ asset('storage/' . $sample->product->display_image) }}" class="product-img" alt="Product Image">
                                @else
