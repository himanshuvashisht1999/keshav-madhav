...
<style>
    ...
    .select2-dropdown {
        ...
        z-index: 10000 !important; /* Ensure it stays on top of everything including sticky footer */
        overflow: hidden;
    }
    ...
    @media (max-width: 991.98px) { .sticky-actions { left: 0; } }
                    ...
                    <div class="card-body-premium">
                        ...
                        <div class="row">
                            <div class="col-md-3 input-group-premium">
                                ...
                                <select name="products[0][product_id]" class="form-control select2 design-select" required>
                            ...
                            <div class="col-md-2 input-group-premium">
                                ...
                                <select name="products[0][pattern_id]" class="form-control select2 pattern-select" required>
                                    <option value="">Pattern</option>
                                </select>
                            </div>
                            <div class="col-md-2 input-group-premium">
                                <label class="label-premium">Fitting *</label>
                                <select name="products[0][fitting_id]" class="form-control select2 fitting-select" required>
                                    <option value="">Fitting</option>
                                </select>
                            </div>
                            <div class="col-md-3 input-group-premium">
                                <label class="label-premium">Warehouse *</label>
                                <select name="products[0][warehouse_id]" class="form-control select2 warehouse-select" required>
                        ...
                        <div class="row">
                            <div class="col-md-3 input-group-premium">
                                ...
                                <select name="products[0][size_set_id]" class="form-control select2 size-set-select" required>
                            ...
                            <div class="col-md-2 input-group-premium">
                                ...
                                <input type="number" name="products[0][total_boxes]" class="form-control form-control-premium" placeholder="Qty" min="1" required>
                            </div>
                            <div class="col-md-2 input-group-premium">
                                <label class="label-premium">Pcs / Box</label>
                                <input type="number" name="products[0][pieces_per_box]" class="form-control form-control-premium bg-light" placeholder="Pcs/Box" readonly required>
                            </div>
                            <div class="col-md-2 input-group-premium">
                                <label class="label-premium">MRP *</label>
                                <input type="number" name="products[0][mrp]" class="form-control form-control-premium mrp-input bg-light" placeholder="Price" step="0.01" min="0" readonly required>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="inventory-item-card animate-in" data-index="${itemCount}">
                    ...
                    <div class="card-body-premium">
                        <div class="row">
                            ...
                            <div class="col-md-2 input-group-premium">
                                <label class="label-premium">Rack</label>
                                <select name="products[${itemCount}][rack_id]" class="form-control select2 rack-select">
                                    <option value="">Rack</option>
                                </select>
                            </div>
                        </div>
