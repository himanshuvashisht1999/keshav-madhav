            ...
            <div class="container-fluid">
                <header class="premium-page-header d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="page-subtitle">Update items and details for PO #{{ $purchase->id }}</p>
                    </div>
                    <a href="{{ route('admin.inventory.purchase_history.index') }}" class="btn btn-outline-secondary btn-sm shadow-sm px-3" style="border-radius: 0.5rem; font-weight: 600;">
            ...
            <div class="container-fluid">
                <form action="{{ route('admin.inventory.purchase_history.update', $purchase->id) }}" method="POST" id="editStockForm">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3" id="vendorContainer" style="{{ $purchase->vendor_id ? '' : 'display: none;' }}">
                        ...
                        <div class="col-md-3" id="customerContainer" style="{{ $purchase->customer_id ? '' : 'display: none;' }}">
                            ...
                            <select name="customer_id" id="customerSelect" class="form-control select2">
                                ...
                                @foreach($customers as $customer)
                                    <option value="{{ $customer->id }}" {{ $purchase->customer_id == $customer->id ? 'selected' : '' }}>{{ $customer->company_name ?? $customer->name }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="card shadow-sm border-0 mb-3 bg-soft-primary animate-in">
                        <div class="card-body p-3">
                            <h6 class="text-primary font-weight-bold mb-3">
                                <i class="fas fa-cart-plus mr-2"></i>Add More Products
                            </h6>
                    ...
                    <div class="card shadow-sm border-0 mb-4 animate-in">
                        <div class="card-body p-0">
                                ...
                                <table class="table table-hover mb-0" id="purchaseTable">
                                    ...
                                    <tbody id="itemsContainer">
                                        ...
                                        <tr class="animate-in" data-index="{{ $idx }}">
                                            <td class="pl-4">
                                                <span class="font-weight-bold text-dark">{{ $item->newProduct->name_of_garment ?? 'N/A' }}</span>
                                            ...
                                            <td>
                                                <div class="badge badge-soft-info" style="background: #eff6ff; color: #2563eb;">{{ $item->newSizeSet->name ?? 'N/A' }}</div>
                                            ...
                                            <td class="text-right pr-4">
                                                <button type="button" class="btn btn-soft-danger btn-sm btn-remove-row" style="background: #fef2f2; color: #ef4444; border: none; border-radius: 0.4rem;">
                            ...
                            <div id="emptyState" class="p-5 text-center text-muted" style="{{ count($purchase->items) > 0 ? 'display: none;' : '' }}">
                    ...
                    <div id="purchaseSummaryContainer" class="card mt-4 shadow-sm border-0">
                        <div class="card-header bg-soft-primary py-3">
                            <h5 class="mb-0 text-primary font-weight-bold"><i
                                    class="fas fa-file-invoice-dollar mr-2"></i>Purchase Summary</h5>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-3 input-group-premium">
                                    ...
                                    <input type="number" name="sub_total" id="global_sub_total"
                                        ...
                                        value="{{ $purchase->sub_total }}" readonly>
                                </div>
                                <div class="col-md-3 input-group-premium">
                                    ...
                                    <div class="input-group">
                                        <input type="number" name="gst_value" id="global_gst_value"
                                            ...
                                            min="0" value="{{ $purchase->gst_value }}">
                                ...
                                <div class="col-md-2 input-group-premium">
                                    ...
                                    <input type="number" name="other_amount" id="global_other_amount"
                                        class="form-control form-control-premium" placeholder="Other" step="0.01" min="0" value="{{ $purchase->other_amount }}">
                                </div>
                                <div class="col-md-2 input-group-premium">
                                    <label class="label-premium">Discount</label>
                                    <input type="number" name="discount" id="global_discount"
                                        class="form-control form-control-premium" placeholder="Disc" step="0.01" min="0" value="{{ $purchase->discount }}">
                                </div>
                                <div class="col-md-3 input-group-premium">
                    ...
                    <div class="sticky-actions">
                        <a href="{{ route('admin.inventory.purchase_history.index') }}" class="btn-cancel">Cancel and Exit</a>
                ...
                function addToTable(data) {
                    ...
                    const rowHtml = `
                                        <tr class="animate-in" data-index="${idx}">
                                            ...
                                            <td>
                                                <div class="badge badge-soft-info" style="background: #eff6ff; color: #2563eb;">${data.size_set_name}</div>
