    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Edit Consumable Voucher</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                            <li class="breadcrumb-item"><a href="{{route('admin.payment.voucher.consumable.index')}}">Consumable Voucher</a></li>
        ...
        <section class="content">
            <div class="container-fluid">
                <form action="{{route('admin.payment.voucher.consumable.update')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card card-outline card-primary shadow-sm">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="consumable_good_id" id="masterSelect" class="form-control select2" required>
                                            ...
                                            @foreach($consumableGoods as $good)
                                                <option value="{{ $good->id }}" {{ $data->consumable_good_id == $good->id ? 'selected' : '' }}>{{ $good->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="card-footer bg-white text-right">
                            <a href="{{ route('admin.payment.voucher.consumable.index') }}" class="btn btn-default mr-2">Cancel</a>
