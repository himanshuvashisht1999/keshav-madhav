                    ...
                    <div class="col-md-8">
                        <div class="card card-outline card-primary shadow-sm">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-edit mr-2"></i>Washing Master Details</h3>
                            </div>
                            <form action="{{route('admin.payment.master.washing_master.update')}}" method="post">
                                @csrf
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control form-control-lg" id="name"
                                                    value="{{ $data->name }}" required placeholder="Enter Washing Master Name">
                                                @error('name')
