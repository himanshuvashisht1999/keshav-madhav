                    ...
                    <div class="col-md-8">
                        <div class="card card-outline card-primary shadow-sm">
                            <div class="card-header">
                                <h3 class="card-title"><i class="fas fa-plus mr-2"></i>Consumable Good Details</h3>
                            </div>
                            <form action="{{route('admin.payment.master.consumable_good.store')}}" method="post">
                                @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control form-control-lg" id="name"
                                                    placeholder="Enter Consumable Good Name" required value="{{ old('name') }}">
                                                @error('name')
