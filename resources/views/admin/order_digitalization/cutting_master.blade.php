                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-section active" id="form-rolls">
                                        ...
                                        <form method="POST" id="rollAssignForm"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="card p-2 mt-3 border">
                                                        ...
                                                        <input type="text" name="bill_number" id="bill_number" class="form-control" placeholder="Enter Bill Number" value="{{ old('bill_number', $cutting_slip->bill_number ?? '') }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="card p-2 mt-3 border">
                                            ...
                                            @php
                                                $cuttingDigitizedPieces = $cutting_slip->total_digitized_pieces ?? 0;
                                                $cuttingTargetPieces = $cutting_slip->total_pieces ?? null;
                                            @endphp
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group border p-2 mt-2">
                                                        ...
                                                        <input type="text" name="bill_number" class="form-control" placeholder="Enter Bill Number" value="{{ old('bill_number', $cutting_slip->bill_number ?? '') }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group border p-2 mt-2">
