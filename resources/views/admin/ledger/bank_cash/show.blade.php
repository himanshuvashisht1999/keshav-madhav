                        ...
                        <form action="{{ route('admin.ledger.bank-cash-ledger.show', ['type' => $type, 'id' => $party->id]) }}"
                            ...
                            <div class="row align-items-end">
                                ...
                                <div class="col-md-{{ $type === 'sales_agent' ? '12 mt-3 text-right' : '6 mt-2 mt-md-0' }}">
                                    ...
                                    <a href="{{ route('admin.ledger.bank-cash-ledger.export-excel', ['type' => $type, 'id' => $party->id, 'start_date' => request('start_date'), 'end_date' => request('end_date'), 'customer_id' => request('customer_id'), 'view_mode' => request('view_mode', 'mix')]) }}"
