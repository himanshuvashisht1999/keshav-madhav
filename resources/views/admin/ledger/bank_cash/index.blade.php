    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2 align-items-center">
                <div class="col-sm-6">
                    <h1 class="m-0 font-weight-bold">Bank & Cash Ledger</h1>
                </div>
                <div class="col-sm-6 text-right text-end">
                    <a href="{{ route('admin.ledger.bank-cash-ledger.export-list-pdf', request()->all()) }}" class="btn btn-danger btn-sm mr-2 shadow-sm font-weight-bold" style="border-radius: 6px;">
                        <i class="fas fa-file-pdf mr-1"></i> PDF
                    </a>
                    <a href="{{ route('admin.ledger.bank-cash-ledger.export-list-excel', request()->all()) }}" class="btn btn-success btn-sm shadow-sm font-weight-bold" style="border-radius: 6px;">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card ledger-card mb-4">
                <div class="card-body">
                    <form action="{{ route('admin.ledger.bank-cash-ledger.index') }}" method="GET">
                        <div class="row align-items-end">
                            ...
                            <div class="col-md-3">
                                ...
                                <a href="{{ route('admin.ledger.bank-cash-ledger.index') }}" class="btn btn-light ml-2" style="border-radius: 20px;">Reset</a>
                            </div>
                        </div>
                    </form>
                </div>
                                ...
                                @forelse($parties as $party)
                                    <tr>
                                        ...
                                        <td class="pr-4 py-3 align-middle text-center">
                                            <a href="{{ route('admin.ledger.bank-cash-ledger.show', ['type' => $party->party_type, 'id' => $party->id]) }}" class="btn btn-sm btn-outline-primary" style="border-radius: 15px;">
