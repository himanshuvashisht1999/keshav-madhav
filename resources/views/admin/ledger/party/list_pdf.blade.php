...
<head>
    ...
    <title>Party Financial Ledger Summary</title>
    <style>
        body {
...
<body>
    <table class="header-table">
        <tr>
            <td style="vertical-align: middle;">
                ...
                <div style="color: #64748b; font-size: 9.5px;">Party Financial Ledger Summary</div>
            </td>
            <td style="vertical-align: middle; text-align: right;">
                <div class="report-title">Party Ledger List</div>
    ...
    <table class="data-table">
        ...
        <tbody>
            ...
            @empty
                <tr>
                    <td colspan="5" class="text-center" style="padding: 15px;">No parties found.</td>
                </tr>
            @endforelse
        </tbody>
        <tfoot>
