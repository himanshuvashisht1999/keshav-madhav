                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <input type="file" name="fav_icon" class="custom-file-input"
                                                        id="icon-input" onchange="previewIcon()" accept=".jpg,.jpeg,.png">
                                                    <label class="custom-file-label" for="exampleInputFile">Choose
                                                        file</label>
                                                </div>
                                    ...
                                    <div class="col-md-6">
                                        <img class="" src="{{$data->logo}}" alt="Preview" id="image-preview" height="80px"
                                            width="80px">
                                    </div>

                                    <div class="col-md-6">
                                        <img class="" src="{{$data->fav_icon}}" alt="Preview" id="icon-preview"
                                    ...
                                    <div class="col-md-6  pt-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="website_name" class="form-control"
                                                placeholder="Enter website name" value="{{$data->website_name}}">
                                    ...
                                    <div class="col-md-6  pt-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="copy_right" class="form-control"
                                                placeholder="Enter copy right " value="{{$data->copy_right}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="3" type="text" name="address" class="form-control"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea rows="3" type="text" name="sub_heading" class="form-control"
                                                placeholder="Enter sub heading" value="">{{$data->sub_heading}}</textarea>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="meta_keywords" class="form-control"
                                            placeholder="Enter Meta Keywords" value="{{$data->meta_keywords}}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="meta_description" class="form-control"
                                            placeholder="Enter Meta Description" value="{{$data->meta_description}}">
                                ...
                                {{-- <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="3" type="text" name="header_script" class="form-control"
                                            placeholder="Enter header script" value="">{{$data->header_script}}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="3" type="text" name="footer_script" class="form-control"
                                            placeholder="Enter footer script" value="">{{$data->footer_script}}</textarea>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="linkedin" class="form-control"
                                            placeholder="Enter linkedin url" value="{{$data->instagram}}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="url" name="android_app" class="form-control"
                                            placeholder="Enter android  url" value="{{$data->android_app}}">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="url" name="ios_app" class="form-control" placeholder="Enter ios  url"
                                            value="{{$data->ios_app}}">
