    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2 align-items-center">
                <div class="col-sm-6">
                    <h1 class="mb-0">Item Stock Details</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('admin.item_stock.itemIndex') }}">Item Stock</a></li>
                        <li class="breadcrumb-item active">View Item Stock</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="card shadow-lg">
                <div class="card-header bg-primary text-white">
                    <h3 class="card-title"><i class="fas fa-boxes mr-2"></i> Item Stock Information</h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="info-box bg-light shadow-sm rounded">
                                <div class="info-box-content">
                                    <span class="info-box-text d-block text-muted mb-1"><strong>Quantity:</strong></span>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="info-box bg-light shadow-sm rounded">
                                <div class="info-box-content">
                                    <span class="info-box-text d-block text-muted mb-1"><strong>Box:</strong></span>
                                    <span class="info-box-number">{{ $data->box }}</span>
                                </div>
                            </div>
                        </div>
            ...
            <div class="mt-3 text-right">
                <a href="{{ route('admin.item_stock.index',['sku' => $data->sku]) }}" class="btn btn-secondary">
