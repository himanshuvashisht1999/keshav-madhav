            ...
            <div class="container-fluid">
                <div class="card card-default">
                    <div class="card-header">
                        <h3 class="card-title">Edit Purchase Agent</h3>
                    </div>
                    <form action="{{route('admin.master.purchase-agent.update')}}" method="post">
                        @csrf
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="address" class="form-control"
                                            placeholder="Enter address" rows="3">{{$data->address}}</textarea>
                                        @error('address')<span class="text-danger small">{{ $message }}</span>@enderror
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Current Balance (Sum of Vendors)</label>
                                        <div class="form-control" style="background-color: #e9ecef;">
                                            @php $total_bal = $data->vendors()->sum('balance'); @endphp
