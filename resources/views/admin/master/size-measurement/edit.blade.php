                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="measurement" class="form-control" placeholder="Enter measurement" value="{{$data->measurement}}">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="base_cloth_consumption" class="form-control" placeholder="Enter base cloth consumption" value="{{$data->base_cloth_consumption}}">
