        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <div class="card card-default">
                    ...
                    <form action="{{route('admin.master.size-measurement.update')}}" method="post"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="no_of_pcs" id="no_of_pcs" class="form-control"
                                            placeholder="Enter No of Pcs" value="{{$data->no_of_pcs}}" readonly>
                                ...
                                {{-- <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="size_group" class="form-control"
                                            placeholder="Enter Size Group" value="{{$data->size_group}}">
                                                    ...
                                                    @foreach ($sizes as $size_data)
                                                        <label>
                                                            <input type="checkbox" name="size_group[]"
                                                                value="{{$size_data->size}}" class="ckkBox val" @if(in_array($size_data->size, $selectedSizes)) checked @endif />
