            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Create Fabric GSM</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            ...
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">Create Fabric GSM</h3>
                </div>
                <form action="{{route('admin.master.fabric_gsm.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
...
<script>
    function generateSKU() {
        ...
        let sku = 'FABRIC-GSM-' + part1 + "-" + part2;
