...
<script>
    $(function () {
        ...
        var oTable = $('#customers').DataTable({
            ...
            "pageLength":25,
            ajax: {
                url: '{!! route('admin.master.materials.indexList') !!}',
                data: function (d) {
                    d.id = $('#id').val();
                    d.name = $('#name').val();
                    d.sku = $('#sku').val();
            ...
            buttons: [
                {
                    text: 'Add Garment Materials',
                    className: 'btn-datatable',
                    action: function (e, dt, node, config) {
                        window.location.href = "{{ route('admin.master.materials.create') }}";
                    }
                }
            ]
        });
    ...
    function deleteData(id){
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = "{{ route('admin.master.materials.delete', ['id' => '']) }}" + id;
            }
        });
    }
</script>
