...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Manage Fabric Dye</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item active">Manage Fabric Dye</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="card card-default ">
                <!-- <div class="row" >
                    <div class="col-9 card-header">
                        <h3 class="card-title">Manage Fabric Dye</h3>
                    </div>
                    <div class="col-3 card-header">
                        <a href="{{route('admin.master.fabric_dye.create')}}" class="btn btn-primary" style =" float: right;  width: max-content;">Add Fabric Dye</a>
                    </div>
                </div> -->
            ...
            buttons: [
                {
                    ...
                    action: function (e, dt, node, config) {
                        window.location.href = "{{ route('admin.master.fabric_dye.create') }}";
                    }
                }
            ]
        });
