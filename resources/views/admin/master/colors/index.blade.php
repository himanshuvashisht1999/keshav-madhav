...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Manage Garment Color</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{route('admin.dashboard')}}">Home</a></li>
                        <li class="breadcrumb-item active">Manage Garment Color</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="card card-default ">
                 <div class="row" >
                    <div class="col-9 card-header">
                        <h3 class="card-title">Manage Garment Color</h3>
                    </div>
                    <div class="col-3 card-header">
                        <a href="{{route('admin.master.colors.create')}}" class="btn btn-primary" style =" float: right;  width: max-content;">Add Color</a>
                    </div>
                </div>
...
<script>
    $(function () {
        ...
        var oTable = $('#customers').DataTable({
            ...
            "pageLength":25,
            ajax: {
                url: '{!! route('admin.master.colors.indexList') !!}',
                data: function (d) {
                    d.id = $('#id').val();
                    d.name = $('#name').val();
                    d.sku = $('#sku').val();
