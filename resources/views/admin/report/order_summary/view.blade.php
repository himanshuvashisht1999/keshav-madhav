                    ...
                    <div class="card shadow-sm mb-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <strong class="d-block text-muted text-uppercase text-xs">Expected Delivery Date</strong>
                                    <span class="h5 text-dark">{{ date('d M, Y', strtotime($order->expected_delivery_date)) }}</span>
                                </div>
                                <div class="col-md-2">
