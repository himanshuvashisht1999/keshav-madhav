        ...
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <h3 class="m-0">
                        <a href="{{ route('admin.report.stock') }}" class="text-dark text-decoration-none">Fabric Stock Report</a>
...
@section('scripts')
<style>
    .table-report th { background: #f8f9fa; font-weight: 600; vertical-align: middle; }
