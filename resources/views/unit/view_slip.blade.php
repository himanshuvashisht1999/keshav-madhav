...
<div class="app-header">
    ...
    <div class="page-title">Slip Details</div>
</div>
    ...
    <div class="card">
        ...
        <div class="info-grid">
            ...
            <div class="info-row">
                ...
                <span class="info-value">{{ $slip->getUnitMaster->name }}</span>
            </div>
            <div class="info-row">
                <span class="info-label">Warehouse</span>
                <span class="info-value">{{ $slip->getUnitMaster->masterFabricWarehouse->cutting_master_name ?? '-' }}</span>
            </div>
            <div class="info-row">
