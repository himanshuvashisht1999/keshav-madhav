...
<div class="responsive-app-view">
    <div class="app-header">
        <div class="breadcrumb-custom">
            <a href="{{ route('owner.bank-cash-ledger.index') }}">Bank & Cash Ledger</a>
    ...
    <div class="filters-section">
        <form action="{{ route('owner.bank-cash-ledger.show', ['type' => $type, 'id' => $party->id]) }}" method="GET" id="filterForm">
            ...
            <div class="d-flex justify-content-between mt-2">
                <a href="{{ route('owner.bank-cash-ledger.show', ['type' => $type, 'id' => $party->id]) }}" class="btn btn-sm" style="background: #f1f5f9; color: var(--text-muted); font-weight: 700; border-radius: 10px;">Clear</a>
                <a href="{{ route('owner.bank-cash-ledger.download', ['type' => $type, 'id' => $party->id] + request()->all()) }}" class="btn btn-sm text-white" style="background: #ef4444; font-weight: 700; border-radius: 10px;"><i class="fas fa-file-pdf mr-1"></i> PDF</a>
            </div>
        </form>
    </div>
