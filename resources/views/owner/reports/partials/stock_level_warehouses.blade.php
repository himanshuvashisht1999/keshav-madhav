                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{ route('owner.stock', ['fabric_id' => request('fabric_id'), 'warehouse_id' => $row->master_fabric_warehouse_id, 'type' => 'receipts']) }}" class="btn btn-sm btn-outline-success me-1" title="View Shipments">
                                <i class="fas fa-arrow-down"></i> Shipments
                            </a>
                            <a href="{{ route('owner.stock', ['fabric_id' => request('fabric_id'), 'warehouse_id' => $row->master_fabric_warehouse_id, 'type' => 'usages']) }}" class="btn btn-sm btn-outline-danger" title="View Usages">
