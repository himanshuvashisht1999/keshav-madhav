...
class ContractorDataTable
{
    ...
    {
        $query = Contractor::with('currentOpeningBalance');
        ...
        return DataTables::of($query)
            ...
            ->addColumn('action', function ($row) {
                return '
                <a href="' . route('admin.payment.master.contractor.edit', ['id' => $row->id]) . '" class="" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-edit text-muted"></i></a>
                <a href="' . route('admin.payment.master.contractor.delete', ['id' => $row->id]) . '" class="ml-2" data-toggle="tooltip" data-placement="top" title="Delete" onclick="return confirm(\'Are you sure you want to delete this contractor?\')"><i class="fas fa-trash text-danger"></i></a>
                ';
            })
