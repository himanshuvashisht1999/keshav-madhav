...
class PurchaseOrderMaterialDataTable{
  ...
  public function indexList($request){
    ...
    return DataTables::of($queue)->addIndexColumn()
            ...
            ->addColumn('id_display', function ($queue) {
                return $queue->id;
            })
            ...
            ->addColumn('action', function ($queue) {
                $parameter= $queue->id;
                return '
                <a href="' . route('admin.purchase_order_material.view',['id' => $parameter]) . '" class="" data-toggle="tooltip" data-placement="top" title="" data-original-title="View"><i class="fas fa-eye text-muted"></i></a>
                ';
            })
