...
class CreatePermissionTables extends Migration
{
    ...
    public function up()
    {
        ...
        if (!Schema::hasTable($tableNames['roles'])) {
            ...
            // If roles table exists, ensure it has guard_name
            ...
            // Force id to bigint unsigned for foreign key compatibility
            \Illuminate\Support\Facades\DB::statement("ALTER TABLE `" . $tableNames['roles'] . "` MODIFY `id` BIGINT UNSIGNED AUTO_INCREMENT");
        }
