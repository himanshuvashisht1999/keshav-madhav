...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('domestic_inventory_histories', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('old_size_set_id');
            $table->unsignedBigInteger('old_color_id');
            ...
            $table->unsignedBigInteger('new_size_set_id');
            $table->unsignedBigInteger('new_color_id');
            $table->unsignedBigInteger('new_fitting_id')->nullable();
            $table->unsignedBigInteger('new_pattern_id')->nullable();
            $table->unsignedBigInteger('new_rack_id');
